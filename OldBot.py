    ...
    if obstacles:
        ...
        if ship.calculate_distance_between(obstacle) - (obstacle.radius) > 13:
            ...
            while not clear_path and try_count < 4:
                ...
                logging.info("Avoiding obstacle: {}".format(obstacle))
                logging.info("We think the bypasses are here: {}".format(vertices))
...
while True:
    ...
    if turn == 0:
        ...
        too_damn_far = True if enemy_ships[0][1] > 180 else False
